...
@interface TextPageControl ()

@property (nonatomic, strong) UIView *contentView; // 内容视图

@property (nonatomic, strong) NSArray<UILabel *> *titleLabels; // 标题标签组

@end


@implementation TextPageControl
...
- (void)setTitles:(NSArray *)titles {
    ...
    for (int i = 0; i < texts.count; i++) {
        ...
        [DemoAppearance setupDefaultShadowOnLayer:label.layer];
